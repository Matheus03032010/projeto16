...
function setup() {
  ...
  score=0;
  fruitGroup=createGroup(); // grupo para frutas
  monsterGroup=createGroup(); // grupo para monstro
}
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    //mover faca com o mouse no x e no y
    ...
    if(fruitGroup.isTouching(knife)){
     ...
     // score=+2;
      // score=2;
      score=score+2; // pontuação se acertar a fruta
  ...
  text("Acerte apenas as frutas: ",250,30);
}// fim draw
...
// cria as frutas
function fruits(){
  if(World.frameCount%80===0){ // de 80 em 80 frames
     ...
     fruit.scale=0.2;
     //fruit.debug=true;
     r=Math.round(random(1,4)); // escolha randomica de fruta
     if (r == 1) {
